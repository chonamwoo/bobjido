...
const Following: React.FC = () => {
  ...
  // Convert socialStore data to FollowingUser format
  const followingData = followingUserDetails.map(user => ({
    ...user,
    isFollowing: true,
  ...
  const filteredFollowing = followingData.filter((user: FollowingUser) =>
