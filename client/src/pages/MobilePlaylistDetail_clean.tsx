          ...
          onSave={(restaurantId) => {
            if (savedRestaurants.includes(restaurantId)) {
              ...
              setRestaurantStats(prev => ({
                ...
                [restaurantId]: {
                  ...prev[restaurantId],
                  saves: Math.max(0, (prev[restaurantId]?.saves || 0) - 1)
                }
              }));
              ...
              setRestaurantStats(prev => ({
                ...
                [selectedRestaurant._id]: {
                  ...
                  likes: prev[selectedRestaurant._id]?.likes || 0,
                  reviews: prev[selectedRestaurant._id]?.reviews || 0
                }
              }));
          ...
          onLike={(restaurantId) => {
            if (likedRestaurants.includes(restaurantId)) {
              ...
              setRestaurantStats(prev => ({
                ...
                [restaurantId]: {
                  ...prev[restaurantId],
                  likes: Math.max(0, (prev[restaurantId]?.likes || 0) - 1)
                }
              }));
              localStorage.setItem('likedRestaurants', JSON.stringify(likedRestaurants.filter(id => id !== restaurantId)));
              ...
              setRestaurantStats(prev => ({
                ...
                [restaurantId]: {
                  ...prev[restaurantId],
                  likes: (prev[restaurantId]?.likes || 0) + 1
                }
              }));
              localStorage.setItem('likedRestaurants', JSON.stringify([...likedRestaurants, restaurantId]));
              toast.success('좋아요!');
            }
            localStorage.setItem('restaurantStats', JSON.stringify(restaurantStats));
          }}
          isSaved={savedRestaurants.includes(selectedRestaurant._id)}
          isLiked={likedRestaurants.includes(selectedRestaurant._id)}
          recommendation={playlist?.restaurants?.find((r: any) =>
