        ...
        <div className="p-4">
          {user && (
            <>
              ...
              {/* 취향 쌍둥이 섹션 - 핵심 기능 바로 아래로 이동 및 강조 */}
              <div className="mb-6">
                <div className="bg-gradient-to-r from-purple-50 to-pink-50 rounded-xl p-4 border-2 border-purple-200">
                  <div className="flex items-center justify-between mb-3">
                    ...
                    <Link to="/matches" className="text-xs text-purple-600 hover:text-purple-700 font-bold">
                      모두 보기 →
                    </Link>
                  </div>
                  <div className="space-y-2">
                    {/* 매칭된 사용자 예시 */}
                    <Link to="/profile/kimfoodie" className="flex items-center gap-2 px-3 py-2 bg-white rounded-lg hover:bg-purple-50 group">
                      <img 
                      ...
                      <div className="flex-1 min-w-0">
                        <p className="text-sm font-medium text-gray-900 truncate group-hover:text-purple-600">김미식</p>
                        <p className="text-xs text-gray-700">이태원 핫플 마스터</p>
                      </div>
                      <span className="text-xs bg-gradient-to-r from-purple-500 to-pink-500 text-white px-2 py-1 rounded-full font-bold">92%</span>
                    </Link>
                    <Link to="/profile/leegourmet" className="flex items-center gap-2 px-3 py-2 bg-white rounded-lg hover:bg-purple-50 group">
                      <img 
                      ...
                      />
                      <div className="flex-1 min-w-0">
                        <p className="text-sm font-medium text-gray-900 truncate group-hover:text-purple-600">이구르메</p>
                        <p className="text-xs text-gray-700">성수 카페 탐험가</p>
                      </div>
                      <span className="text-xs bg-gradient-to-r from-purple-500 to-pink-500 text-white px-2 py-1 rounded-full font-bold">88%</span>
                    </Link>
                    <Link to="/profile/parkchef" className="flex items-center gap-2 px-3 py-2 bg-white rounded-lg hover:bg-purple-50 group">
                      <img 
                      ...
                      />
                      <div className="flex-1 min-w-0">
                        <p className="text-sm font-medium text-gray-900 truncate group-hover:text-purple-600">박요리</p>
                        <p className="text-xs text-gray-700">강남 미식 전문가</p>
                      </div>
                      <span className="text-xs bg-gradient-to-r from-purple-500 to-pink-500 text-white px-2 py-1 rounded-full font-bold">85%</span>
                    </Link>
                  </div>
                </div>
              </div>

              {/* 같이 먹어요 섹션 - 두 번째 위치 및 강조 */}
              <div className="mb-6">
                <div className="bg-gradient-to-r from-yellow-50 to-orange-50 rounded-xl p-4 border-2 border-yellow-200">
                  <div className="flex items-center justify-between mb-3">
                    ...
                    <Link to="/dining-buddy" className="text-xs text-orange-600 hover:text-orange-700 font-bold">
                      더보기 →
                    </Link>
                  </div>
                  <div className="space-y-2">
                    <Link to="/dining-buddy/1" className="block px-3 py-2 bg-white rounded-lg hover:bg-yellow-50 transition-all">
                      <div className="flex items-center justify-between mb-1">
                        <span className="text-sm font-medium text-gray-900">오마카세 같이 가실분</span>
                        <span className="text-xs text-orange-600 font-bold">오늘 7PM</span>
                      </div>
                      <p className="text-xs text-gray-600">청담 · 1인당 15만원 · 2명 구해요</p>
                    </Link>
                    <Link to="/dining-buddy/2" className="block px-3 py-2 bg-white rounded-lg hover:bg-yellow-50 transition-all">
                      <div className="flex items-center justify-between mb-1">
                        <span className="text-sm font-medium text-gray-900">퇴근후 양꼬치 한잔</span>
                        <span className="text-xs text-yellow-600 font-bold">내일 6PM</span>
                      </div>
                      <p className="text-xs text-gray-600">건대입구 · 부담없이 · 3명 모여요</p>
                    </Link>
                  </div>
                </div>
              </div>
